...
Lo primero que vamos a hacer es entrar a la página web de Odoo. Una vez dentro, iremos a la pestaña de precios. 
   ...
   ![Pagina principal](../assets/img/03-instalacion/paso01_paginaprincipal.png)


   Eligiremos la opcion gratuita de la estandar

   ![Eleccion](../assets/img/03-instalacion/paso02_eleccionestandar.png)
   
2. **Seleccionar apps iniciales** 
Despues de haber seleccionado la prueba gratuita, nos da a elegir 10 aplicaciones

   -![Aplicaciones](../assets/img/03-instalacion/paso03_eleccionaplicacion.png)

   Una vez elegidas, nos registramos completando los campos 

   ![Registro](../assets/img/03-instalacion/paso04_registro.png) 
 ...
 ![Menu](../assets/img/03-instalacion/paso05_menu.png) 
...
3. **Instalar/Desinstalar apps** 
   ...
   ![App](../assets/img/03-instalacion/paso06_app.png) 
   ...
   ![borrar](../assets/img/03-instalacion/paso07_borrar.png) 
